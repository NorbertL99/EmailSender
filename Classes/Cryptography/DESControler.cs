...
namespace Email_Sender.Classes.Cryptography
{
    ...
    {
        #region VARIABLES
        private static byte[] KEY_BYTES = Encoding.ASCII.GetBytes("wef12gba");
        private static byte[] IV_BYTES = Encoding.ASCII.GetBytes("wgsnod29");
        #endregion
        ...
        protected string DESEncryption(string _text)
        {
        ...
        protected string DESDecryption(string _encryptedText)
        {
